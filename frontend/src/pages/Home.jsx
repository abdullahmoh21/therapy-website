...
const Home = () => {
  return (
    <>
              ...
              <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
                <div>
                  <div className="lg:w-[570px] ml-[40px]">
                    <h1 className="text-[51.27px] leading-[46px] font-semibold text-headingColor mr-[200px] w-full">
                      Fatima Mohsin Naqvi,{" "}
                    </h1>
                    <h2 className="text-[26.25px] leading-[46px] text-headingColor mr-[200px] w-full pb-3">
                      Licensed Therapist | NYU Graduate
                    </h2>
                    <NavLink
                      to="/signup"
                      className="py-2 px-4 bg-black text-white h-[58px] w-[179px]
                             border-white rounded-[20px] hover:bg-[#2c2c2c]"
                    >
                      Book a Session
                    </NavLink>
                  </div>
      ...
      {/* ------ Second White ------- */}
      <section className="home-bg h-[663px]"></section>
    </>
  );
};
