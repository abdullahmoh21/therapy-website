  ...
  return (
    <>
      <section className=' home-bg h-[663px]'>
        <h1 className='text-[51.27px] font-bold text-[#c45e3e] text-center pb-3'>About Me</h1>
      ...
      <section className='bg-[#c45e3e] h-[663px]'>
        <div className='w-full'>
          ...
          <h1 className='text-[51.27px] text-center font-bold text-white mx-auto w-full pb-[60px]'>Why Choose me?</h1>
